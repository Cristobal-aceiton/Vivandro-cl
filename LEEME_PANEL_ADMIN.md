...
4. **Iniciar sesión** en el sitio con la cuenta `cristobalaceiton4@gmail.com` y entrar a `admin-panel.html`. Con cualquier otra cuenta, el panel muestra "No tienes acceso" y no deja pasar (y aunque alguien fuerce la interfaz, el paso 2 ya bloqueó la escritura en la base de datos).

## Notas de seguridad, en corto

- El email autorizado está **hardcodeado en las políticas RLS de la base de datos**, no en el frontend. Eso es lo que realmente lo protege.
